...
parser.add_argument('--epochs', type=int, default=10, help='epochs for training  (default: 50)')
...
parser.add_argument('--pred_len', type=int, default=12, help='how many steps away we want to predict')
